...
List bns=["General Agriculture","Tractor","Crop disease management","Agriculture Production","Food Security","Repurposing Agricultural","Farming White Black"];
List ans=["muniraj singh rathore","Lee klancher","Ajay Kumar","Sarah Waetcher","Samir Droby","Lee klanche","Ajay Kumar"];
List vots=["4.4","3.9","3.8","4.1","4.3","3.7","3.3"];
...
>
  <head>
    ...
    <title> Ghiras Library | Admin </title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Ghiras Lobrary /</span> All Books </h4>
</html>
    ...
    <div class="col-md-6 col-lg-4 mb-3">
        <div class="card h-100">
            ...
            <div class="card-body">
                ...
                <p class="card-text"></p>
                <a href="editDeleteBook.php?id=<?php echo $id;?>" class="btn btn-outline-primary" style="margin-left: 100px">Show Deatails</a>
            </div>
        </div>
    </div>
<?php

...
>
  <head>
    ...
    <title>Users - Reports | Admin </title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Reports /</span> Users</h4>
...
for ($i = 0; $i < $res->num_rows; $i++) {
    while ($row = $res->fetch_object()) {
        ...
        ?>
        <tr>
            <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong><?php echo $username?></strong></td>
            <td>offensive post</td>
            <td>
                <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                    <li
                            ...
                            title="<?php echo $username2?>"
                    >
                        <a href="userProfile.php" ;>
                            <img src="<?php echo $img?>" alt="Avatar" class="rounded-circle" />
                        </a>
                    </li>

                </ul>
            </td>
            <td><span class="badge bg-label-primary me-1"><?php echo $job?></span></td>
            <td>
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        ><i class="bx bx-trash me-1" onclick="delete "></i> Delete</a
                        >
                    </div>
                </div>
            </td>

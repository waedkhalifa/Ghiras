        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Posts /</span> User Posts </h4>
                ...
                $qrystr = "select * from posts";
                $res = $db->query($qrystr);

                for ($i = 0; $i < $res->num_rows; $i++) {
                while ($row = $res->fetch_object()) {
                $imagename="imgs/".$row->userimg;
                $image="imgs/".$row->postimg;
                $contexy=$row->context;
                ...
                <div class="card-body">
                    <table>
                        <tr>
                                ...
                                <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                                    ...
                                    >
                                        <a href="userProfile.php" ;>
                                            <img src="<?php echo $imagename?>" alt class="w-px-40 rounded-circle" style="height: 40px;margin-top: -10px" />
                                        </a>
                                    </li>
                            ...
                            <td>
                                <h5 class="card-title" style="margin-top:10px;margin-left:15px"><?php echo $username?></h5>
                            </td>
                        </tr>
                    </table>
                    ...
                    <p class="card-text">
                        <?php echo $contexy?></p>
                    <a href="userPost.php?postId=<?php echo $postid?>" class="btn btn-outline-primary">Show Post</a>
                </div>
            </div>
          </div>
                    <?php

...
>
  <head>
    ...
    <title>Repoets | User Information</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Reports/</span> User Information</h4>
                <?php
                ...
                $qrystr = "select * from users where userid=".$_POST['userid'];
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      ...
                      <small class="text-muted float-end">Check info</small>
                    </div>
                    <div class="card-body">
                      <form>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="basic-default-name" placeholder="<?php echo  $userEmail?>" />
                          </div>
                        </div>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-company">Job</label>
                          <div class="col-sm-10">
                            <input
                              type="text"
                              class="form-control"
                        ...
                        <div class="col-sm-10">
                        <a href="#" class="click"><button type="button" class="btn btn-primary">Delete Account</button></a>
                        </div>
                        </div>
                          ...
                          <div class="btns">
                            ...
                            <a href="index.html" class="btn2" onclick="delete ">Delete Account</a>
                          </div>
                        </div>
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Reports /</span> User Posts</h4>
                ...
                $qrystr = "select * from products where userid=".$_POST['userid'];

                $res = $db->query($qrystr);

                for ($i = 0; $i < $res->num_rows; $i++) {
                while ($row = $res->fetch_object()) {
                $username= $res->productname;
                $image= $res->image;
                $comtext= $res->context;
                ...
                <div class="col-md-6 col-lg-4 mb-3">
                  <div class="card h-100">
                    ...
                    <div class="card-body">
                      ...
                      <a href="userPost.php?postid= <?php echo $_POST['postid']?>" class="btn btn-outline-primary">Show Post</a>
                    </div>
                  </div>
                </div>
              <!-- Examples -->
...
?>
                <!-- Horizontal -->
                <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Reports /</span> User Products</h4>
                <div class="row mb-5">
                  <div class="col-md">
                      ...
                      <div class="row g-0">
                        <div class="col-md-4">
                          <img class="card-img card-img-left" src="../assets/img/elements/product1.jpeg" alt="Card image" />
                        </div>
                        <div class="col-md-8">
                          <div class="card-body">
                            <h5 class="card-title"><?php echo $productname?></h5>
                            <p class="card-text"><?php echo $about?></p>
                            <p class="card-text"><small class="text-muted"><?php echo $productPrice?></small></p>
                          </div>
                        </div>
                      </div>
                    </div>

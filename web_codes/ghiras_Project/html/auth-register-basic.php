...
>
  <head>
    ...
    <title>Register - Page | Ghiras - Admin</title>
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-4">Welcome to Ghiras...Palestinian farmers community </p>
...
if(isset($_POST['sub'])) {
    ...
    if ($ll == 0) {
        ...
        $sql = "INSERT INTO users (username,email,password) VALUES ('$uname','$emaill','$passw')";

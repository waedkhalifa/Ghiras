...
>
  <head>
    ...
    <title>Ghiras Library  | Edit Book </title>
                    ...
                    <li>
                      <a class="dropdown-item" href="#">
                        <span class="d-flex align-items-center align-middle">
                          ...
                          <span class="flex-shrink-0 badge badge-center rounded-pill bg-danger w-px-20 h-px-20"><?php$_SESSION["username"]?></span>
                        </span>
                      </a>
                    </li>
                    <li>
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      ...
                      <small class="text-muted float-end">Edit | Remove</small>
                    </div>
                    <div class="card-body">
</html>
    ...
    while ($row = $res->fetch_object()) {
        ...
        ?>
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="basic-default-fullname"  value="<?=$bookName;?>" />
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-company">Author Name</label>
                          <input type="text" class="form-control" id="basic-default-company" value="<?=$author;?>" />
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-email" style="margin-right: 100px">Cover</label>
                          <input type="file" class="form-control" id="basic-default-email" value=""/>
                        ...
                        <div class="mb-3">
                          ...
                          <h>if you want to change</h>
                          <input type="file" class="form-control" id="basic-default-pdf" value=""/>
                          <iframe src= "<?=$context;?>", style="height: 300px;width: 300px" ></iframe>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="row justify-content-end">
                          <div class="col-sm-10">
                            <a href="books.php" class="click"><button type="submit" class="btn btn-primary" style="width: 120px">Save</button></a>
                            <button type="submit" name="del" class="btn btn-primary" style="margin-left: 100px;width: 120px">Remove</button>
                          </div>
                        </div>
                        ...
                        <div class="popup_box">
                          ...
                          <div class="btns">
                            ...
                            <a href="index.html" class="btn2">Delete</a>
                          </div>
                        </div>

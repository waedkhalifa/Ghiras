...
>
  <head>
    ...
    <title>Ghiras Library | Add </title>
              ...
              <div class="col-xl">
                <div class="card mb-4">
                  <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Book Deatials</h5>
                  ...
                  <div class="card-body">
                    <form>
                      <div class="mb-3">
                        ...
                        <input type="text" name="book" class="form-control" id="basic-default-fullname"  value="" />
                      </div>
                      <div class="mb-3">
                        <label class="form-label" for="basic-default-company">Author Name</label>
                        <input type="text" name="author" class="form-control" id="basic-default-company" value="" />
                      </div>
                      <div class="mb-3">
                        <label class="form-label" for="basic-default-email" style="margin-right: 100px">Cover</label>
                        <input type="file" name="up1" class="form-control" id="basic-default-email" value=""/>


                      </div>

                      <div class="mb-3">
                        <label class="form-label" for="basic-default-pdf">PDF File</label>
                        <input type="file" name="up2" class="form-control" id="basic-default-pdf" value=""/>
                        </div>
                      <div class="mb-3">
                        <label class="form-label" for="basic-default-message">About The Book</label>
                        <textarea
                                style="height: 200px"
                      ...
                      <a href="books.php">
                    <button type="submit" name="sub" class="btn btn-primary" style="margin-left: 200px;width: 120px">Save</button>
                      </a>
...
<?php
if(isset($_POST['sub'])&& isset($_FILES['up']))
{

    $target="imgs/".basename($_FILES['up']['name']);
    $conn = new mysqli('localhost', 'root', '', 'mozare');
    $image=$_FILES['up1']['name'];
    $pdf=$_FILES['up2']['name'];
    $bookName=$_POST['book'];
    $author=$_POST['author'];
    $text=$_POST['text'];
    ...
    $sql = "INSERT INTO books (bname,author,cover,context,overview) VALUES ('$bookName','$author','$image','$pdf','$text')";
    if ($conn->query($sql) === TRUE)
    {
        ?>
        <div style="width:300px;height:0;z-index: 1;font-size: 15px;color: darkgreen;position: relative;top: -1055px;left: 380px">Successfully added</div>
        <?php
    }
    ...
    {
        ?>
        <div style="width:300px;height:0;z-index: 1;font-size: 15px;color: red;position: relative;top: -1055px;left: 380px">Already exist</div>
        <?php
    }
    $conn->close();
    if(move_uploaded_file($_FILES['up1']['tmp_name'], $target))
    {

    }
    if(move_uploaded_file($_FILES['up2']['tmp_name'], $target))
    {

...
session_start();
if(isset($_POST['sub'])){
    $wrong="YOU ENTER WRONG EMAIL OR PASSWORD";
    $uname = $_POST['user'];
    $upass = $_POST['pass'];
    $logged=0;
...
>
  <head>
    ...
    <title>Login - Page | Ghiras - Admin</title>
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <h4 class="mb-2">Welcome to Ghiras! 👋</h4>
              ...
              <form id="formAuthentication" class="mb-3" action="index.html" method="POST">
                ...
                <div class="mb-3">
                  <button class="btn btn-primary d-grid w-100" name="sub"type="submit">Sign in</button>
                </div>
              </form>
